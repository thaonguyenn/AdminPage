...
<form action="<%=request.getContextPath()%>/NhanVienController"
		...
		<input type="hidden" name="hidId" value="<c:out value="${nhanVien.maNV}" />">
		<div class="generic-container">
			<div class="well lead">Cập nhật nhân viên</div>
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-label" for="txtMaNV">Mã nhân viên</label>
					<div class="col-md-7">
						<input type="text" id="txtMaNV" name="txtMaNV"
							class="form-control input-sm" value="<c:out value="${nhanVien.maNV}"/>" readonly="readonly"/>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="text" id="txtTenNV" name="txtTenNV"
							class="form-control input-sm" value="<c:out value="${nhanVien.tenNV}" />"/>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="text" id="txtQueQuan" name="txtQueQuan"
							class="form-control input-sm" value="<c:out value="${nhanVien.queQuan}" />"/>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="text" id="txtChucVu" name="txtChucVu"
							class="form-control input-sm" value="<c:out value="${nhanVien.chucVu}" />"/>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="text" id="txtMaPB" name="txtMaPB"
							class="form-control input-sm" value="<c:out value="${nhanVien.maPB}" />"/>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<input type="text" id="txtHeSo" name="txtHeSo"
							class="form-control input-sm" value="<c:out value="${nhanVien.heSoLuong}" />"/>
			...
			or <a href="<c:url value='/NhanVienController?action=index' />">Quay lại</a>
	</form>
